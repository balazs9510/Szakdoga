...
class MonoPackageManager_Resources {
	public static final String[] Assemblies = new String[]{
		/* We need to ensure that "WorkoutPlaner.Droid.dll" comes first in this list. */
		"WorkoutPlaner.Droid.dll",
		"ExifLib.dll",
		"FormsViewGroup.dll",
		...
		"WorkoutPlaner.DAL.dll",
		"WorkoutPlaner.dll",
		"WorkoutPlaner.Common.dll",
		"WorkoutPlaner.BLL.dll",
	};
